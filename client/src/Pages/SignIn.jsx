...
export default function SignIn() {
  ...
  return (
    ...
    >
      <div className=" w-2/5 h-2/3 bg-slate-200 border border-gray-800  rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative top-10 bg-transparent ">
