...
export default function CreateListing() {
  ...
  return (
    <div className="text-cyan-300 font-semibold h-screen bg-cover "
    style={{
      backgroundImage: `url(${bgImg})`,
    }}>
      <div className="w-2/5 h-3/4 bg-slate-200 border border-gray-800 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative top-10 left-1/3 bg-transparent ">
    ...
    <main className='p-3 max-w-2xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <select
  className='mt-1 mb-2 h-12 w-full px-2 py-1 rounded focus-within:outline-red-300 bg-white opacity-70 text-black'
  id='name'
